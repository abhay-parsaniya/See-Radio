      ...
      <div>
        <div className="wrapper">
          <section className="hero">
            <div className="header-content">
              <div className="container">
                <div className="row justify-content-center text-center header-content py-5">
                  <div className="col-md-10 col-lg-6">
                    ...
                    <p className="lead">
                      Where you choose to work has impact on your productivity
                      and creativity. It also says a lot about your business. We
                      are the right office space.
                    </p>
          ...
          <section id="sec-features" className="sec-features pt-5 pb-5">
            <div className="container">
              <div className="row align-items-center bg-info p-5 card-border">
                <div className="col-md-6">
                  <h3 className="h2">Lockers</h3>

                  <hr />

                  <p className="h4">
                    Lockers come in all different shapes and sizes and can be
                    hired in any building, even if its not your home building.
                  </p>
                </div>
              ...
              <div className="row align-items-center bg-secondary text-white p-5 card-border">
                <div className="col-md-6 text-center">
                  <svg
                    className="feature-icon"
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="col-md-6">
                  <h3 className="h2">Building address/Mail handling</h3>

                  <hr />

                  <p className="h4">
                    A Czech business address for you and your mail. We can
                    either hold your mail for you to collect, or forward it on
                    to wherever you are.
                  </p>
                </div>
              </div>
              ...
              <div className="row align-items-center bg-info p-5 card-border">
                <div className="col-md-6">
                  <h3 className="h2">Call answering</h3>

                  <hr />

                  <p className="h4">
                    Well provide someone to answer your calls professionally
                    using your company name. Theyll be put through to you, or
                    well take a message if youre unavailable.
                  </p>
                </div>
          ...
          <section id="sec-pricing" className="sec-pricing">
            <h1 className="h4 mb-5 text-center">Great prices for everyone</h1>
            <div className="container  ">
              <div className="row">
                  ...
                  <div className="card text-center price-card p-5">
                    <div className="card-block ">
                      ...
                      <p className="card-text">
                        The flexible place to grow your projects in a community
                        of start-ups, freelancers and entrepreneurs, flex desk.
                      </p>
                ...
                <div className="col-md-4">
                  <div className="card text-center price-card  p-5">
                    <div className="card-block">
                      ...
                      <p className="card-text">
                        Your own personal area in an open space: desk, drawers,
                        locker and bookcase to accessorise however you like.
                      </p>
                ...
                <div className="col-md-4">
                  <div className="card text-center price-card p-5">
                    <div className="card-block  justify-content-center">
                      ...
                      <p className="card-text">
                        Your own private space, perfect for work teams of up to
                        50 people, inside a structure that’s always in motion
                      </p>
